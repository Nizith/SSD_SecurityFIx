      ...
      <div className="flex flex-col w-full">
        ...
        >
          <div className="flex flex-col justify-center items-center py-16">
            ...
            {/* <svg className="absolute bottom-0 left-0 w-full h-20" viewBox="0 0 1440 100" preserveAspectRatio="none">
              <path fill="white" d="M0,0 C720,140 1440,0 1440,0 V100 H0 V0 Z"></path>
            </svg> */}
